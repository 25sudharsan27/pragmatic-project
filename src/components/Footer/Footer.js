        ...
        <div className="footer">
            ...
            <div id="footer-icon-links" className="footer-links">
                ...
                <div className="footer-icons">
                    <img onClick={()=>{window.open("https://x.com/Pragmaticpc","blank")}}  className="footer-icon" src={twitter}  />
                    <img onClick={()=>{window.open("https://www.linkedin.com/company/pragmaticpc/","blank")}} className="footer-icon" src={linkedin} />
                    <img onClick={()=>{window.open("https://youtube.com/@pragmaticpc?si=gO2nUA0pSwH4I7zP","blank")}}  className="footer-icon" src={youtube}  />
                    <img onClick={()=>{window.open("https://www.facebook.com/profile.php?id=100088823687752","blank")}} className="footer-icon" src={facebook}  />
                    <img onClick={()=>{window.open("https://whatsapp.com/channel/0029Va7AX1CEwEk4jVzMmZ3y","blank")}}  className="footer-icon" src={whatsapp}  />
                </div>
            </div>
            ...
            <div id="footer-for-mobile" class="footer-links">
                <h1 className="footer-heading">Services</h1>
                <div className="footer-links-container">
    {services.map((service, index) => {
      return <a href="/services" className="footer-link" >{service.label}</a>;
    })}
  </div>
        </div> */}
